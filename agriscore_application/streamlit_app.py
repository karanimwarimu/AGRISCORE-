...
from  explainer import load_explainer, plot_shap_summary, get_shap_interactions
...
# ===================== GLOBAL INSIGHTS =====================
    ...
    if st.button("Generate Global SHAP Summary Plot"):
        with st.spinner("Generating..."):
            df_bg = pd.read_csv(os.path.join(data_path , "Final_dataset.csv")).sample(800, random_state=42)
